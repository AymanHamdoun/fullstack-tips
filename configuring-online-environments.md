...
- We need to verify that our setup file is right and no one sent us a funny version. Composer's page on GitHub tells us what the hash of the setup file should look like, so all we need to do is hash our file's content and compare it to the hash GitHub told us about.
